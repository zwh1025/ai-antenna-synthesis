...
- **单次合成与加速比**：AI(NPU) 0.499 ms，对 AP/SOCP/GA/PSO 加速 21,625×/46,080×/70,140×/164,128×；AP 独立验收口径 −0.5~−19.3 dB（12算例，`teacher_stage0a.json`；此前 −34.97 dB 为设计网格采样伪影，已修正），独立口径下 AI 副瓣与速度均优于 AP；
